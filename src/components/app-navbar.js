        ...
        <nav class="fixed bottom-0 left-0 w-full bg-[--highlight-bg-color] border-t-2 border-[--primary-border-color]">
            <div class="flex justify-around items-center h-[14vh] mx-[2vw]">
                ...
                <div class="flex flex-col flex-1 basis-4 w-[15vw] max-w-[125px] h-4/5 items-center justify-center -translate-y-7">
                    <button id="addfood-button" class="primary flex p-0 m-0 rounded-full border-2 border-[--text-color] h-full max-w-full aspect-square text-[0px] items-center justify-center">
                        <!-- AddFood-2 -->
